...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "cezary.pokropek.tasktimer.provider";
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // e.g. content://cezary.pokropek.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS);
        // e.g. content://cezary.pokropek.tasktimer.provider/Tasks/8
...
//                return DurationsContract.TaskDurations.CONTENT_ITEM_TYPE;
                ...
                default:
                    throw new IllegalArgumentException("unknown UriL " + uri);
        }
    }
